...
class SMTR(pl.LightningModule):
	...
	def __init__(self, learning_rate=1e-2):
		...
		self.norm10 = NormActivation(Rs20, activation=ssp)
		self.norm11 = NormActivation(Rs21, activation=ssp)
		self.norm12 = NormActivation(Rs22, activation=ssp)
		...
		self.norm20 = NormActivation(Rs30_exp, activation=ssp)
		self.norm21 = NormActivation(Rs31_exp, activation=ssp)
		self.norm22 = NormActivation(Rs32_exp, activation=ssp)
		...
		self.norm30 = NormActivation(Rs40_exp, activation=ssp)
		self.norm31 = NormActivation(Rs41_exp, activation=ssp)
		self.norm32 = NormActivation(Rs42_exp, activation=ssp)
