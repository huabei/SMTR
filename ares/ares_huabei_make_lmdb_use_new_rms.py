...
train_output_lmdb = root_dir + '/data/lmdbs/train/classics_train_new_rms'
val_output_lmdb = root_dir + '/data/lmdbs/val/classics_val_new_rms'
filetype = 'pdb'
